...
import { Stars, ArrowRight, ArrowLeft, ListFilter, Plus } from "lucide-react";
function orders() {
  return (
        ...
        <div className="px-6 py-8  text-black">
          ...
          <div className="box ">
            <h1 className="font-semibold p-3 ">
              All Orders <span className="text-gray-400"> 442</span>
            </h1>
          ...
          <p className="p-3 text-gray-400 flex gap-x-1.5 md:hidden justify-center">
            Showing <span className="text-black"> 1</span> to
            <span className="text-black">10</span> of
            <span className="text-black"> 467</span> results
          </p>
